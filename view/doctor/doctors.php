...
<div class="container">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb" class="fw-bold my-4 h4">
                <ol class="breadcrumb justify-content-center">
                    <li class="breadcrumb-item"><a class="text-decoration-none" href="../user/index.php"
                            >Home</a></li>
            ...
            <div class="doctors-grid">
                ...
                if(isset($_GET['id'])){
                    ...
                    $filter=["major_id" => $_GET['id']];
                    $doctors=getDataFromTable("doctors", $con,["*"],$filter);
                }else{
                    $doctors=getDataFromTable("doctors", $con);
                ...
                <div class="card p-2" style="width: 18rem;">
                    <img src="../../public/file/<?php echo $doc['image'] ?>" class="card-img-top rounded-circle card-image-circle"
                        alt="major">
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        <h4 class="card-title fw-bold text-center"><?php echo $doc['name'] ?></h4>
                        <?php $doctor_major=getonerow("major",$con,["*"],["id" =>$doc['major_id']])?>
                        <h6 class="card-title fw-bold text-center"><?php echo $doctor_major['name'] ?></h6>
                        <a href="../doctor/appoinment.php?id=<?php echo $doc['id'] ?>" class="btn btn-outline-primary card-button">Book an
                            appointment</a>
                    </div>
                </div>
